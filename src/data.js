import Foccus from './assets/img/Cars/FordFocusrm.png';
import Toyota from './assets/img/Cars/ToyotaCorrolarm.png';
import GTD from './assets/img/Cars/gtdrm.png';
import Honda from './assets/img/Cars/Hondacrvrm.png';
...
import pnue from './assets/img/Accesoires/pneu.png';
import logoTest from './assets/img/testimonial/avatar1.png'
import logoTest2 from './assets/img/testimonial/avatar1.png'
export const cars = [
  {
    type: 'Hatchback',
    name: 'Ford Focus',
    ...
    image: Foccus,
    info: [
      { icon: trans, text: 'Manual' },
      { icon: siege, text: '5 Seats' },
      { icon: station, text: 'Gas' },
      { icon: moteur, text: '1600 HP' },
      { icon: pnue, text: 'Front' },
    ],
  },
  {
    type: 'Hatchback',
    name: 'Volskwagen 7 GTD',
    price: 29,
    stars: 3.5,
    image: GTD,
    info: [
...
export const testimonials = [
  ...
  {
    message: "Had an amazing experience!",
    avatar: logoTest2,
    name: "Jane Smith",
    job: "Project Manager"
  },
...
export const removeLocalStorages = ()=>{
  localStorage.removeItem('selectedPickLocation');
      localStorage.removeItem('pickUpDate');
      localStorage.removeItem('pickUpHour');
      localStorage.removeItem('pickUpMinute');
      localStorage.removeItem('dropOffDate');
      localStorage.removeItem('dropOffHour');
      localStorage.removeItem('dropOffMinute');
      localStorage.removeItem('daysBetween');
      localStorage.removeItem('car_price');
      localStorage.removeItem('selectedReturnLocation');
      localStorage.removeItem('selectReturnOption');
      localStorage.removeItem('hotelDropName');
